# -*- coding: utf-8 -*-
"""
Created on Tue Sep 11 10:26:59 2018

The last section of this file plots the 32 channels in a time duration (not sure about interpretation)
...
for i in range(2): #possible to plot t0 as a function of samples (at one time point only)
    plt.scatter(t0,y)
    plt.pause(0.05)
